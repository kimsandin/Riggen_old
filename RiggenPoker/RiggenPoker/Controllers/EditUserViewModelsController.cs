...
namespace RiggenPoker.Controllers
{
    public class EditUserViewModelsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,UserName,FirstName,LastName,Email")] EditUserViewModel editUserViewModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,UserName,FirstName,LastName,Email")] EditUserViewModel editUserViewModel)
        {
            if (ModelState.IsValid)
            {
